...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'dOB', self.gf('django.db.models.fields.DateField')(null=True))
        ...
        db.alter_column(u'users_userprofile', 'phoneNumber', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.dOB'
        db.alter_column(u'users_userprofile', 'dOB', self.gf('django.db.models.fields.DateField')(default=2))
